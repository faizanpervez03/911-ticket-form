  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
      ...
      <div>
        ...
        {errors.disposition && (
          <p className="mt-2 sm:mt-3 flex items-center gap-1 text-xs sm:text-sm text-red-600">
            <FiAlertCircle size={14} /> {errors.disposition}
          </p>
        )}
      </div>
      ...
      <div>
        ...
        {errors.closingNotes && (
          <p className="mt-1 sm:mt-2 flex items-center gap-1 text-xs sm:text-sm text-red-600">
            <FiAlertCircle size={14} /> {errors.closingNotes}
          </p>
        )}
      </div>
        ...
        <div className="flex gap-2 sm:gap-3 flex-wrap">
          {['Low', 'Medium', 'High', 'Critical'].map((level) => (
            <button
              ...
              className={`px-3 sm:px-4 py-1 sm:py-2 rounded-lg font-medium text-xs sm:text-sm transition duration-200 ${
      ...
      <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-3 sm:p-6">
        <h3 className="font-semibold text-slate-900 mb-2 sm:mb-4 flex items-center gap-2 text-sm sm:text-base">
      ...
      <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 mt-6 sm:mt-8">
        ...
        <button
          type="submit"
          disabled={isLoading}
          className="flex-1 bg-green-600 hover:bg-green-700 text-white font-semibold py-2 sm:py-3 px-3 sm:px-4 rounded-lg transition duration-200 disabled:bg-slate-400 disabled:cursor-not-allowed text-sm sm:text-base"
        >
